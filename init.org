...
** Files
   ...
   I don't use [[http://www.gnu.org/software/emacs/manual/html_node/emacs/Easy-Customization.html][Customize]]
   #+BEGIN_SRC emacs-lisp :tangle yes
...
* Minibuffer (search, commands)
  I prefer Ivy/Counsel/Swiper over Helm
  #+BEGIN_SRC emacs-lisp :tangle yes
...
** Autocompletion
   ...
   Company. There's also Auto-Complete as an alternative.
   #+BEGIN_SRC emacs-lisp :tangle yes
     (use-package company
